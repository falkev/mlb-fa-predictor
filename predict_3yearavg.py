...
SP_CODES  = {"17", "20"}           # starting pitcher codes
RP_CODES  = {"15", "16", "18", "19"}  # relief pitcher codes
C_CODES   = {"1"}
CI_CODES  = {"3", "14"}            # 1B, DH
MI_CODES  = {"6", "11", "5", "4"}            # 2B, SS (6=2B in some exports)
OF_CODES  = {"7", "8", "9", "10"}  # LF/CF/RF
...
def assign_position_group(row):
    ...
    # Fallback for hitters with PA but no recognizable position
    if pd.notna(pa):
        return "CI"
...
SP_FEATURES = [
    "stat_GS", "stat_IP", "stat_W", "stat_L", "stat_ERA", "stat_FIP",
    "stat_WHIP", "stat_ERA+", "stat_H9", "stat_HR9", "stat_BB9", "stat_SO9",
    "stat_SO/BB", "stat_BB", "stat_SO", "stat_WAR", "stat_stat_SO_W",
] + COMMON_CONTEXT
SP_FEATURES += ["stat_WAR_2yr", "stat_ERA_2yr", "stat_FIP_2yr",
                "stat_WAR_3yr", "stat_ERA_3yr", "stat_WAR_trend"]
RP_FEATURES = [
    "stat_G", "stat_SV", "stat_IP", "stat_ERA", "stat_FIP",
    "stat_WHIP", "stat_ERA+", "stat_H9", "stat_HR9", "stat_BB9", "stat_SO9",
    "stat_SO/BB", "stat_BB", "stat_SO", "stat_WAR", "stat_stat_SO_W",
] + COMMON_CONTEXT 
RP_FEATURES += ["stat_WAR_2yr", "stat_ERA_2yr", "stat_FIP_2yr",
                "stat_WAR_3yr", "stat_ERA_3yr", "stat_WAR_trend"]

C_FEATURES = [
    "stat_G", "stat_PA", "stat_HR", "stat_R", "stat_RBI", "stat_BB",
    "stat_SO", "stat_BA", "stat_OBP", "stat_SLG", "stat_OPS", "stat_OPS+",
    "stat_WAR", "stat_rOBA", "stat_Rbat+", "stat_stat_ISO", "stat_stat_BB_K", "stat_WAR_2yr", "stat_OPS_2yr", 
                    "stat_WAR_3yr", "stat_OPS_3yr", "stat_WAR_trend"
] + COMMON_CONTEXT 

MI_FEATURES = [
    "stat_G", "stat_PA", "stat_HR", "stat_R", "stat_RBI", "stat_SB",
    "stat_BB", "stat_SO", "stat_BA", "stat_OBP", "stat_SLG", "stat_OPS",
    "stat_OPS+", "stat_WAR", "stat_rOBA", "stat_Rbat+",
    "stat_stat_ISO", "stat_stat_BB_K", "stat_WAR_2yr", "stat_OPS_2yr", 
                    "stat_WAR_3yr", "stat_OPS_3yr", "stat_WAR_trend"
] + COMMON_CONTEXT
...
CI_FEATURES = [
    "stat_G", "stat_PA", "stat_HR", "stat_R", "stat_RBI", "stat_BB",
    "stat_SO", "stat_BA", "stat_OBP", "stat_SLG", "stat_OPS", "stat_OPS+",
    "stat_TB", "stat_WAR", "stat_rOBA", "stat_Rbat+",
    "stat_stat_ISO", "stat_stat_BB_K", "stat_WAR_2yr", "stat_OPS_2yr", 
                    "stat_WAR_3yr", "stat_OPS_3yr", "stat_WAR_trend"
] + COMMON_CONTEXT
...
OF_FEATURES = [
    "stat_G", "stat_PA", "stat_HR", "stat_R", "stat_RBI", "stat_SB",
    "stat_BB", "stat_SO", "stat_BA", "stat_OBP", "stat_SLG", "stat_OPS",
    "stat_OPS+", "stat_TB", "stat_WAR", "stat_rOBA", "stat_Rbat+",
    "stat_stat_ISO", "stat_stat_BB_K", "stat_WAR_2yr", "stat_OPS_2yr", 
                    "stat_WAR_3yr", "stat_OPS_3yr", "stat_WAR_trend"
] + COMMON_CONTEXT
...
# SALARY INFLATION
# Average AAV per year — used to normalize salaries before training so the
# model learns performance → relative value, not performance → 2018 dollars.

def compute_inflation_index(df):
    """
    Returns a dict {year: mean_AAV} and a scalar for 2026 (extrapolated).
    We'll normalize each player's AAV by their year's mean, train on that,
    then multiply predictions back up by the 2026 mean.
    """
    ...
    # Extrapolate 2026 mean using linear trend of last 4 years
...
def train_group_models(train_path):
    ...
    # Compute and apply inflation normalization
...
def predict_players(df, models, feat_cols, mean_2026):
    ...
    for _, row in df.iterrows():
        ...
        # Multiply normalized prediction back to 2026 dollars
        pred_aav = pred_norm * mean_2026
        ...
        pred_aav = max(pred_norm * mean_2026, 600000)  # MLB minimum salary floor
...
def plot_pred_vs_actual(signed_preds, save_path="2026_pred_vs_actual.png"):
    df = signed_preds[signed_preds["Actual_AAV"].notna()].copy()
...
def plot_top_predictions(preds, title, save_path, n=20):
    ...
    bars = ax.barh(df["label"], df["Predicted_AAV"] / 1e6, color=colors)
...
def plot_feature_importance(models, feat_cols, top_n=12):
    for group, model in models.items():
        ...
        plt.tight_layout()
        save_path = f"importance_2026_{group}.png"
        plt.savefig(save_path, dpi=150)
        print(f"  Saved: {save_path}")
...
def main():
    print("=== 2026 MLB FA Salary Predictor (Position-Group Models, 3 Year avg) ===\n")
    ...
    # Add this temporarily at the end of main(), before the plots
    print("\n--- ACCURACY BY GROUP ---")
